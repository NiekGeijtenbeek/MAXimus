...
//        if( y > DISPLAY_HEIGHT ){hwlib::cout << "ERROR: coordinate y value is out of range. " << y-DISPLAY_HEIGHT << " too big.\n";}
    ...
    */
    ...
    //Function only written for unit testing!
    friend std::ostream & operator<<( std::ostream & lhs, coordinate pos ){
   lhs << "(" << pos.x << "," << pos.y << ")";
   return lhs;
}
